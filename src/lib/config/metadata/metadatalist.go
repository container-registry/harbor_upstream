...
var (
	...
	ConfigList = []Item{
		...
		{Name: common.EnableProjectFederatedIDP, Scope: UserScope, Group: BasicGroup, EnvKey: "ENABLE_PROJECT_FEDERATED_IDP", DefaultValue: "false", ItemType: &BoolType{}, Editable: false, Description: `The option to enable federated idp for project`},
