...
Harbor uses [Taskfile](https://taskfile.dev) for local development and building. This provides a fast, hybrid development environment with hot reload capabilities.
