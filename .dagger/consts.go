...
var (
	...
	TRIVY_VERSION_NO_PREFIX    = "0.66.0"
	TRIVY_DOWNLOAD_URL         = "https://github.com/aquasecurity/trivy/releases/download/v0.66.0/trivy_0.66.0_Linux-64bit.tar.gz"
	TRIVY_ADAPTER_DOWNLOAD_URL = "https://github.com/goharbor/harbor-scanner-trivy/archive/refs/tags/v0.34.0.tar.gz"
)
